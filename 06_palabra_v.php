<div class="row justify-content-center m-1">
    <div id="mensaje" class="card-group col-sm-12 col-md-9 col-lg-6 col-xl-6 justify-content-center p-0">
        <!-- AQUI PINTO EL MENSAJE -->
    </div>
</div>

<!-- AÑADIR/ACTUALIZAR PALABRA -->
<div class="modal fade" id="myModal-añadirPalabra">
    <div class="modal-sm modal-lg modal-xl modal-dialog modal-dialog-centered">
        <div class="modal-content">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 p-0">
                    <div class="card p-3">
                        <form id="formPalabra">
                            ...
                            <input type="hidden" id="NComu" name="NC" />
                            ...
                            <div class="form-group">
                                <label>Lugar</label>
                                <div>
                                    <select class="form-control" id="lugarE" name="lugar" required>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea class="form-control" id="detallesP" name="detallesP" required></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div>
                                    <button id="nuevaPalabra" type="submit" class="btn btn-primary btn-block">Añadir palabra</button>
                                    <button id="actualizarPalabra" type="submit" class="btn btn-primary btn-block">Actualizar palabra</button>
                                </div>
                            </div>
                        </form>
            ...
            <button id="activadorP" type="none" class="d-none" data-target="#myModal-añadirPalabra" data-toggle="modal"></button>
        </div>
    </div>
</div>

<!-- POPUP ALERT ELIMINAR PALABRA -->
    ...
    <div class="modal-sm modal-lg modal-xl modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" id="mensaje">
                <p>Vas a eliminar la palabra <strong id="eliminado"></strong>, ¿Estas seguro de que deseas eliminarla?</p>
            </div>
            <div class="modal-footer">
