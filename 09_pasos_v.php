<div class="row justify-content-center m-1">
    <div id="mensaje" class="card-group col-sm-12 col-md-9 col-lg-6 col-xl-6 justify-content-center p-0">
        <!-- AQUI PINTO LOS PASOS -->
    </div>
</div>

<!-- AÑADIR/ACTUALIZAR PASO -->
<div class="modal fade" id="myModal-añadirPaso">
    <div class="modal-sm modal-lg modal-xl modal-dialog modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <div class="card p-3">
                        <form id="formPaso">
                            ...
                            <div class="form-group">
                                <label>Lugar</label>
                                <div>
                                    <select class="form-control" id="lugarE" name="lugarE" required />
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div>
                                    <button id="nuevoPaso" type="submit" class="btn btn-primary btn-block">Añadir paso</button>
                                    <button id="actualizarPaso" type="submit" class="btn btn-primary btn-block">Actualizar paso</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <button id="activadorP" type="none" class="d-none" data-target="#myModal-añadirPaso" data-toggle="modal"></button>
        </div>
    </div>
</div>
    ...
    <div class="modal-sm modal-lg modal-xl modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" id="mensaje">
                <p>Vas a eliminar el paso de <strong id="eliminado"></strong>, ¿Estas seguro de que deseas eliminarla?</p>
            </div>
            <div class="modal-footer">
